...
async function main() {
    ...
    const personas = [
        ...
        { slug: 'eng_admin', displayName: 'Engagement Lead', description: 'Also known as Engagement Lead. Responsible for managing a specific engagement. Can manage engagement members, update engagement content, and oversee collaboration within the engagement workspace. Usually a project manager, engagement lead, or team lead.' },
        { slug: 'eng_member', displayName: 'Contributor (Internal)', description: 'Internal team member contributing to engagement work. Gets default access to all engagement content alongside the rest of the internal team. Typically full-time employees or core engagement team members.' },
        { slug: 'eng_ext_collaborator', displayName: 'Contributor (External)', description: 'External collaborator invited to contribute to an engagement. Can edit content explicitly shared with them (e.g. a deliverable-in-progress status) but has limited access outside the engagement scope. Typically contractors, consultants, vendors, or agency partners.' },
