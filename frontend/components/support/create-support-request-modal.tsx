  ...
  return (
    <>
      {wrapTrigger(trigger || (
        <button
          type="button"
          className="h-auto px-4 py-1.5 rounded-[2px] bg-[#069668] text-white text-[10px] font-headline font-bold tracking-widest uppercase hover:brightness-105 active:scale-95 transition-all shadow-sm inline-flex items-center gap-1.5"
        >
