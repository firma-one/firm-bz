...
import { AlertTriangle, ChevronDown, Lock, Linkedin, Users2, MapPin, X, CornerDownLeft, User, Activity, Building2, Globe, FileText, Tag, Share2, CalendarClock, CalendarCheck } from 'lucide-react'
    ...
    return (
        <div className="flex flex-col gap-3">
            ...
            <div className="grid grid-cols-3 gap-3">
                ...
                <div className="row-span-2 bg-white rounded border border-[#e5e7eb] p-4 space-y-3">
                    ...
                    <div>
                        ...
                        <textarea id="client-description" value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Additional details about the client" rows={2} disabled={isSandboxFirm} className={textareaCls} />
                    </div>
                </div>
                ...
                <div className="col-span-2 bg-white rounded border border-[#e5e7eb] p-4 space-y-3">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        ...
                        <div>
                            ...
                            <DateTimePicker value={expectedCloseDate} onChange={setExpectedCloseDate} placeholder="Select date" disabled={isSandboxFirm || status !== 'PROSPECT'} defaultTime="17:00" />
            ...
            <div className="flex items-center gap-3">
                ...
                <Button onClick={handleSave} disabled={isSandboxFirm || saving} variant="greenCta" className="rounded-[2px] w-32 text-[10px] font-headline font-bold tracking-widest uppercase text-white">
                    {saving ? 'Saving…' : 'Save'}
                </Button>
            </div>
