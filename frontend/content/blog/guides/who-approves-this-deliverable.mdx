---
title: 'Who Approves This? Why Client Deliverables Stall on Ambiguity, Not Disagreement'
date: '2026-08-31'
excerpt: >-
  Most client deliverables stall because nobody knows whose approval counts. A shared link grants access but assigns no role, leaving the approval chain to live in your head. Here is how to separate access from accountability.
category: guides
tags:
  - client-delivery
  - approvals
...
id: guides-who-approves-this-deliverable-2026-08-31
author: Firma Editorial
authorTitle: Client Delivery Expert
...
# Who Approves This? Why Client Deliverables Stall on Ambiguity, Not Disagreement
...
## What a shared link can and cannot hold

Here is the mechanism underneath all of this.
...
**Chasing the wrong person.** You follow up with the person who has been most responsive, because responsiveness is the only signal you have. They are frequently not the blocker. The actual approver is unaware they are holding anything up.

**Discovering the approver was on leave.** Nobody told you, because nobody knew that person's absence had consequences for your deliverable.

**Re-litigating what is current.** Without a state on the artifact, the second version does not visibly supersede the first. Someone reviews the wrong file and gives feedback you already addressed.
...
**Client-side confusion you get blamed for.** The client's team is not organised either. When your process does not impose clarity, theirs will not supply it, and the resulting mess reads to them as your delivery being disorganised.
...
These four habits, applied consistently, remove most of the stall. They are also, notably, the things that get dropped first when you are running five engagements at once, which is precisely why encoding them into a system beats relying on remembering them.
...
At six clients the arithmetic changes. It is not three times the load. Each client contributes deliverables, and each deliverable contributes a role map, and switching between clients means reloading a different map from memory. The cost is in the context switching as much as the volume.
...
The mistake is not using Drive. Drive is the right place for files to live, and moving them somewhere else creates a migration problem in exchange for solving a structure problem. The mistake is expecting storage to carry structure it was never designed to hold, and then treating the resulting friction as a personal organisational failing.

The work is the unit. Not the file. Once you organise around the engagement rather than the folder, roles and states have somewhere to attach, and the question "who approves this" stops being something you answer from memory every time.
